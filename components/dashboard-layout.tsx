...
export function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="mr-auto flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden md:block text-right">
                <p className="text-sm font-medium leading-none">أحمد الشمري</p>
                <p className="text-xs text-muted-foreground mt-1">محامي أول</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'} fixed lg:sticky top-16 right-0 z-40 h-[calc(100vh-4rem)] w-64 border-l border-border bg-sidebar transition-transform duration-300 ease-in-out`}>
